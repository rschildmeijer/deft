...
"home=Cosby&favorite+flavor=flies\r\n";
	...
	private static final Logger LOG = LoggerFactory.getLogger(HttpParserBenchmarkTest.class);
	...
	public void loadTestHttpRequestParser(){
        ...
        for (int nb = 0; nb < 10; nb++){
			...
			while (i < CYCLES){
				...
				Assert.assertTrue("Request should be finished", req.isFinished());
		...
		LOG.info("TimeStats parsing with HttpRequestParser\t\t: Min={}, Max={}, Avg={}", new String[]{serTime.min + "", serTime.max + "",
	...
	public void loadTestHttpRequest(){
		...
		LOG.info("TimeStats parsing with HttpRequest\t\t: Min={}, Max={}, Avg={}", new String[]{serTime.min + "", serTime.max + "",
                serTime.getAvg(CYCLES) + ""});
		   }
	}
    ...
    /**
     * Objet utilisŽ pour calculer les temps de traitements minimum, maximum et moyen. A chaque itŽration, il suffit d'ajouter le temps de
     * traitement au TimeStat pour mettre ˆ jour les statistiques de temps.
     * 
     * @author slm
     * 
     */
    ...
    class StopWatch {
        ...
        /**
         * Arret du compteur et retour du temps en nanosecondes ŽcoulŽ depuis le dernier appel ˆ {@link #start()}
         * 
         * @return
         */
        public long stop() {
